<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="InstitutionType.aspx.cs" Inherits="Payroll.Institution.InstitutionType" %>
...
<ContentTemplate>
    <h2>Institution Type Details</h2>
    <br />

    <input id="ButtonNew" type="button" value="Add New InstitutionType" class="button" onclick="return ButtonNew_onclick()" /><br />
        ...
        <div id="formdiv" align="center">
            ...
            <table id="formtable" cellpadding="5" >
                <tr>
                    ...
                    <td><asp:TextBox ID="txtInstitutionTypeName" runat="server" CssClass="longText" 
                            MaxLength="50"></asp:TextBox></td>
                    <asp:RequiredFieldValidator ID="RFVtxtInstitutionTypeName" runat="server" 
                        ErrorMessage="Enter Institution Type" ControlToValidate="txtInstitutionTypeName" Display="None"
 ...
 <br />
        ...
        <div id="maingrid" align="center">
            ...
            <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <asp:BoundField DataField="InstitutionTypeId" HeaderStyle-CssClass="hiddenItem" ItemStyle-CssClass="hiddenItem" />   
                    <asp:BoundField DataField="InstitutionTypeName" HeaderText="Institution Type" />
