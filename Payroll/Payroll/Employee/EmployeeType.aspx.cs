...
namespace Payroll.Employee
{
    public partial class EmployeeType : System.Web.UI.Page
    {
        ...
        private static int intEmployeeTypeId = 0;    //when user clicks on edit the id of the selected row is copied to this variable
        ...
        private void FillGrid()
        {
            ...
            gvMain.DataSource = employee.GetAllEmployeeTypes();
            gvMain.DataBind();

            //If no data is selected shows appropriate message
            if (gvMain.Rows.Count == 0)
            {
                lblErrorMsg.Text = "No Employee Type Added yet.";
        ...
        /// <summary>
        /// This method saves the Employee Type details and returns save status
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void ButtonSave_Click(object sender, EventArgs e)
        {
            if (SaveEmployeeType() != -1)     //means it is saved            
            {
                lblErrorMsg.ForeColor = System.Drawing.Color.Green;
                lblErrorMsg.Text = "Employee Type Saved Successfully";
        ...
        #region SaveEmployeeType

        /// <summary>
        /// This method saves the EmployeeType details
        /// </summary>
        private int SaveEmployeeType()
        {
            try
            {
                PayrollModel.EmployeeType employeetype = new PayrollModel.EmployeeType();

                //Fills the properties of employeetype object with values in the inputs.
                AddValues(employeetype);

                return new Payroll_Manager.Employee().AddEmployeeType(employeetype);  //Successfully saved. so, 1 is returned
            }
            catch (Exception ex)
            {
        ...
        private void AddValues(PayrollModel.EmployeeType employeetype)
        {
            //Fills the properties of employeetype object with values in the inputs.
            employeetype.EmployeeTypeName = txtEmployeeTypeName.Text;
        }
        ...
        private void AddValues()
        {
            ...
            intEmployeeTypeId = Convert.ToInt32(gvMain.Rows[gvMain.SelectedIndex].Cells[0].Text.Trim());

            //Creating an object of Employee Class
            Payroll_Manager.Employee employee = new Payroll_Manager.Employee();

            //Setting the data source with the list of employeetype
            PayrollModel.EmployeeType employeetype = employee.GetEmployeeTypeById(intEmployeeTypeId);
        ...
        /// <summary>
        /// This method modifies the EmployeeType details and returns save status
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void ButtonUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (UpdateEmployeeType() != -1)     //means it is updated            
            {
                lblErrorMsg.ForeColor = System.Drawing.Color.Green;
                lblErrorMsg.Text = "EmployeeType Updated Successfully";
        ...
        /// <summary>
        /// This method updates the EmployeeType details
        /// </summary>
        private int UpdateEmployeeType()
        {
            try
            {
                ...
                return employee.UpdateEmployeeType(employeetype);
