<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="Religion.aspx.cs" Inherits="Payroll.Religion" %>
...
<ContentTemplate>
    ...
    <input id="ButtonNew" type="button" value="Add New Religion" class="button" onclick="return ButtonNew_onclick()" /><br />
        ...
        <div id="formdiv" align="center">
            ...
            <table id="formtable" cellpadding="5" >
                <tr>
                    ...
                    <td><asp:TextBox ID="txtReligionName" runat="server" CssClass="longText" 
                            MaxLength="50"></asp:TextBox></td>
                    <asp:RequiredFieldValidator ID="RFV_txtReligionName" runat="server" 
                        ErrorMessage="Enter Religion Name" ControlToValidate="txtReligionName" Display="None"
                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                </tr>

                <tr>
                    <td colspan="2" align="right">
                        <asp:Button ID="ButtonSave" runat="server" ClientIDMode="Static" CssClass="buttonAsp" Text="Save" 
                            onclick="ButtonSave_Click" />
                        <asp:Button ID="ButtonUpdate" runat="server" ClientIDMode="Static" CssClass="buttonAsp" Text="Update" 
 ...
 <br />
        ...
        <div id="maingrid" align="center">
            ...
            <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" 
                CellPadding="5" onselectedindexchanged="gvMain_SelectedIndexChanged" 
                CssClass="gridview" >
                <Columns>
                    <asp:BoundField DataField="ReligionId" HeaderStyle-CssClass="hiddenItem" ItemStyle-CssClass="hiddenItem" />                    
