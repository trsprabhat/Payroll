<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="DepartmentType.aspx.cs" Inherits="Payroll.Company.DepartmentType" %>
...
<ContentTemplate>
    <h2>Department Type Details</h2>
    <br />

    <input id="ButtonNew" type="button" value="Add New DepartmentType" class="button" onclick="return ButtonNew_onclick()" /><br />
        ...
        <div id="formdiv" align="center">
            ...
            <table id="formtable" cellpadding="5" >
                <tr>
                    ...
                    <td><asp:TextBox ID="txtDepartmentTypeName" runat="server" CssClass="longText" 
                            MaxLength="50"></asp:TextBox></td>
                    <asp:RequiredFieldValidator ID="RFVtxtDepartmentTypeName" runat="server" 
                        ErrorMessage="Enter Department Type" ControlToValidate="txtDepartmentTypeName" Display="None"
 ...
 <br />
        ...
        <div id="maingrid" align="center">
            ...
            <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <asp:BoundField DataField="DepartmentTypeId" HeaderStyle-CssClass="hiddenItem" ItemStyle-CssClass="hiddenItem" />   
                    <asp:BoundField DataField="DepartmentTypeName" HeaderText="Department Type" />
